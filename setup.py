...
VERSION = "1.17"
DESCRIPTION = "easyPyPI (Pronounced 'Easy Pie-Pea-Eye') is a quick, simple, " \
              "one-size-fits-all solution for sharing your Python creations on the Python Package Index (PyPI) " \
              "so others can just `pip install your_script` with no fuss."
LICENSE = "MIT License"
AUTHOR = "Peter Fison"
...
CLASSIFIERS = ["Development Status :: 4 - Beta, Intended Audience :: Developers, "
               ...
               "Topic :: System :: Software Distribution, Topic :: Utilities"]
